...
function App() {
  ...
  return (
    <div className="h-screen w-screen grid grid-cols-12"> {/* Main container with 12 columns */}
      {/* Column for LocationSearch component */}
      <div className="col-span-3 p-2"> {/* Spanning 3 columns with padding */}
      ...
      <div className="col-span-9"> {/* Spanning 9 columns */}
